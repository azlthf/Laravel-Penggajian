...
@section('content')
    <div class="col-12 ps-4">
        <h4>Tambah Data Gaji</h4>
            <a href="/Gaji/index" class="btn btn-info btn-md p-2 mb-3">Back</a>
    </div>
    <div class="col-12 ps-4">
        ...
        <div class="mb-3 row">
            <label for="inputPassword" class="col-sm-2 col-from-label">Bulan</label>
            <div class="col-sm-10">
                <select class="form-control">
        ...
        <div class="d-grid text-end">
            <div class="col-sm-12">
                <button class="btn btn-success btn-m" type="submit">SUBMIT</button>
            </div>
        </div>            
            </form>
        </div>
